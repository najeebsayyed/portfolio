      ...
      <div className="mx-auto grid w-full max-w-7xl items-center gap-16 px-6 lg:grid-cols-2">
        ...
        <div>
          ...
          <h1 className="mt-4 text-5xl font-bold leading-tight md:text-7xl">
            Hi, I'm <span className="text-emerald-400">Abdullah</span>
          </h1>
          ...
          <p className="mt-6 max-w-xl text-lg leading-relaxed text-gray-400">
            ...
            using React Native, TypeScript, Firebase and Supabase.
          </p>
          ...
          <div className="relative">
            ...
            <div className="relative rounded-[40px] border-4 border-emerald-400 bg-[#08111F] p-3">
              <img
                src={profile}
                alt="Abdullah"
                className="h-[500px] w-[380px] rounded-[30px] object-cover"
              />
            </div>
          </div>
        </div>
